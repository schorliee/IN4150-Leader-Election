...
//        this.current = serverList.size();
        ...
        Integer[] keys = this.can_serverList.keySet().toArray(new Integer[0]);
        Random random = new Random();
        this.current = keys[random.nextInt(keys.length)];
...
//                this.current--;
//                this.can_serverList.keySet();
//                this.current=this.can_serverList.;
                Integer[] keys = this.can_serverList.keySet().toArray(new Integer[0]);
                Random random = new Random();
                this.current = keys[random.nextInt(keys.length)];
...
//                    this.current--;
//                    this.can_serverList.remove(this.current);
